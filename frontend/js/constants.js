...
const welcome_p = "The OmniApes is an omnichain NFT collection built on @LayerZero_Labs. OmniApes can be transferred to any supported chains (Ethereum, BNB Chain, Avalanche, Polygon, Arbitrum, Fantom, Optimism)";
